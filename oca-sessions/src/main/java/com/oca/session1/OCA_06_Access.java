 ...
 * Line 19 is the tricky one: The protected method is only callable through pure inheritance (line 23), not by using a reference variable of Parent and calling the method.
 */
