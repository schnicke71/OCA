...
public class OCA_07_Precedence {
	...
	public static void main(String[] args) {
		...
		int i = 0;
		System.out.println(++i == 0 && --i > 1 | - --i == 1); // Oswald says: false
		System.out.println("i after example 1=" + i); // Oswald says: 1
		
		i = 0;
		System.out.println(++i == 0 & --i > 1 | - --i == 1); // true
		System.out.println("i after example 2=" + i); // i=-1
